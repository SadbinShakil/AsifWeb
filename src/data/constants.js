...
export const books = [
  {
    ...
    year: "2018",
    description:
      "এই বইটি একটি 'স্লাইস অব লাইফ' গল্পের মাধ্যমে প্রস্তুত করা, যা আপনাকে সাধারণ মানুষের জীবনের নিকটস্থ এবং আপাতকালীন অংশে নিয়ে যাবে। এখানে সম্পর্ক, ভালোবাসা, হাসি, কষ্ট, সাহায্য এবং সামাজিক সমস্যা গুলির সমাধান সহ জীবনের বিভিন্ন দিক উপস্থাপন করা হয়েছে। এই গল্পগুলি আপনার আত্মবিশ্বাস বৃদ্ধি করতে এবং আপনার জীবনের সামগ্রিক প্রেক্ষাপট পরিবেশন করতে সাহায্য করতে পারে।",
