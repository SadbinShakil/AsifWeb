...
export const gallery = [ 
  ...
  },
  {
    ...
    description:
      "In this captivating photo taken under the moonlight, the title 'Oshrushunno Rodon' is more than a name;" +
        ...
        "the essence of the book but also freezes a moment in time, reminiscent of the quiet, magical hours when the words came alive beneath" +
        "the moonlit sky, etching a beautiful memory in the process.",
    image:
...

  {
    id: 3,
    description:
      "In this awe-inspiring photo, I stand against a majestic mountain backdrop, surrounded by the breathtaking beauty of nature. The towering" +
      "peaks and expansive landscapes echo the sense of adventure and wanderlust that defines my love for travel. With a heart full of appreciation" +
      "for the wonders of the world, the image captures a moment of serenity and connection with the great outdoors. It's a visual testament to my" +
      "passion for exploring new horizons and seeking inspiration from the unparalleled grandeur of the natural world. This photograph encapsulates" +
      "the joy and fulfillment that comes with the exploration of diverse landscapes, making every journey a chapter in the story of my adventurous spirit.",
    image:
